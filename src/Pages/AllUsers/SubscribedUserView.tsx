...
interface SubscribedUserDetails {
    userName: string;
    dateOfBirth: string;
...
const user: SubscribedUserDetails = {
    userName: "John Doe",
        ...
        <div className="w-full min-h-screen bg-gray-50 text-[#111827]">
            <div className="px-4 sm:px-8 pt-6 pb-16 space-y-6">
                ...
                <div className="bg-white rounded-[14px] border border-gray-200 shadow-sm overflow-hidden">
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="relative md:w-56 bg-gradient-to-b from-blue-50 via-indigo-60 to-blue-300 flex flex-col items-center justify-center py-10 px-6 shrink-0 overflow-hidden border-r border-blue-200">
                            ...
                            <p className="relative z-10 mt-1 text-[11.5px] text-blue-800 text-center break-all">{user.email}</p>

                            <div className="relative z-10 mt-4 flex flex-wrap justify-center gap-1.5">
                                <span className={`px-2.5 py-0.5 rounded-full text-[11px] font-semibold border ${user.approved
                        ...
                        <div className="flex-1 flex flex-col justify-between p-6 gap-5">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2 border-t border-gray-100">
                                {[
                                    ...
                                    { icon: <Crown size={15} className="text-purple-500" />, bg: "bg-purple-50", label: "Plan", value: user.subscriptionPlan },
                ...
                <Section
                    ...
                    iconBg="bg-purple-50"
                    sectionIcon={<Crown size={16} className="text-purple-600" />}
                >
                    <Field icon={<Crown size={15} />} label="Subscription Plan" value={user.subscriptionPlan} />
                    <Field icon={<Calendar size={15} />} label="Start Date" value={user.subscriptionStart} />
                    <Field icon={<Calendar size={15} />} label="End Date" value={user.subscriptionEnd} />
                    <Field icon={<Info size={15} />} label="User Mode" value={user.userMode} />
                    <Field icon={<Ticket size={15} />} label="Tickets Purchased" value={user.totalTicketPurchase} />
                    <Field icon={<ThumbsUp size={15} />} label="Total Likes" value={user.userLikeCount} />
                </Section>
                ...
                <Section
                    ...
                    iconBg="bg-indigo-50"
                    sectionIcon={<Briefcase size={16} className="text-indigo-600" />}
                >
