...
export default function Search({ searchTerm, setSearchTerm, placeholder, onClick, showBadge }: SearchBarProps) {
    return (
        <div onClick={onClick} className="relative w-full md:w-[350px] lg:w-[300px]  xl:w-full cursor-pointer mb-0.5" >
            ...
            <input
                ...
                className="w-full pl-9 pr-16 py-2 border border-gray-300 hover:border-[var(--brand-primary)] rounded-lg text-sm text-gray-900 placeholder:text-gray-500 focus:outline-none cursor-pointer"
            />
