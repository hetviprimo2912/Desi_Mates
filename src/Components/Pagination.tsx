        ...
        <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-[14px] px-4 h-[48px]">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-1 text-[15px] font-medium text-[#344054] cursor-pointer"
            >
              {rowsPerPage}
              <ChevronDown
                size={16}
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="w-8 h-8 rounded-[10px] border border-gray-200 bg-white flex items-center justify-center text-gray-500 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
          >
            «
          </button>
          ...
          {getPageNumbers().map((page, index) => (
            <button
              ...
              className={`w-9 h-9 rounded-[10px] text-sm font-semibold flex items-center justify-center transition-all ${
                currentPage === page
          ...
          <button
            ...
            className="w-8 h-8 rounded-[10px] border border-gray-200 bg-white flex items-center justify-center text-gray-700 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
          >
            ›
          </button>
